...
TICKERS = ["NVDA","GOOGL","AAPL","MSFT","AMZN","AVGO","META","TSLA","WMT","LLY","JPM","MU","AMD","XOM","V","JNJ","INTC","ORCL","COST","CSCO","MA","CAT","CVX","NFLX","ABBV","BAC","UNH","KO","PG","AMAT","PLTR","MS","HD","PM","GE","GS","MRK","TXN","RTX","LIN","KLAC","WFC","QCOM","AXP","IBM","C","TMUS","ADI","PEP","PANW","MCD","VZ","NEE","DIS","ANET","BLK","AMGN","BA","T","TJX","APP","TMO","UNP","GILD","SCHW","CRWD","ISRG","DELL","ABT","UBER","DE","COP","WELL","APH","ETN","CRM","PFE","BX","HON","PLD","VRT","CB","SPGI","MO","CVS","LOW","LMT","SBUX","BKNG","SYK","PGR","NEM","BMY","COF","DHR","INTU","VRTX"]
